...
<body>
	...
	<script type="text/javascript">
		...
		Game.setDirection  = function(direction) {
			...
			Game.socket2.send("Kilroy was here");
			Console.log('socket2 Sent: Kilroy was here');
		...
		Game.connect = (function() {
			...
			Game.socket2 = new SockJS("ws");
			
			Game.socket2.onopen = function () {
				Console.log('Info: WebSocket socket2 connection opened.');
			};
			...
			Game.socket2.onmessage = function (message) {
				console.log(" socket2.onmessage : message.data", message.data);
			};			
