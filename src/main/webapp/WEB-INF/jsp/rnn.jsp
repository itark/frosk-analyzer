...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">RNN Prediction</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    $(document).ready(function() {
        ...
        var featStratTable = $('#featuredStrategies').DataTable({
        	responsive: true,
        	select: true,
        	"sAjaxSource": "/featuredStrategies?strategy=RNNStrategy&database=YAHOO",
			"sAjaxDataProp": "",
			"order": [[ 3, "desc" ]],
			"aoColumns": [
				  { "mData": "name"},
    ...
    function renderChart(strategyName, security) {
    	console.log('about to render chart on strategyName='+strategyName+ ' and security='+security);
     	...
     	var rnnPricesUrl = "rnnPrices?security="+security+"&database=YAHOO";
