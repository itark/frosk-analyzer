package nu.itark.frosk.bot.bot.dto.util;
...
public final class CurrencyDTO implements Serializable {
     ...
     */
    public CurrencyDTO(final Builder builder) {
     ...
     */
    private CurrencyDTO(final String newAlternativeCode, final CurrencyAttributes newAttributes) {
    ...
    public static final class Builder {
         ...
         * @return builder
         */
        public Builder code(final String newCode) {
            this.code = newCode;
            return this;
        }
