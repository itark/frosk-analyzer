...
/**
 * CassandreStrategy is the class that every strategy used by user ({@link nu.itark.frosk.bot.bot.strategy.BasicCassandreStrategy} must extend.
 ...
 * - CassandreStrategy (class) is the class that every strategy used by user ({@link nu.itark.frosk.bot.bot.strategy.BasicCassandreStrategy} must extend. It contains methods to access data and manage orders, trades, positions.
