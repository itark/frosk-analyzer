...
@Slf4j
@SpringBootTest
public class TestJRecommendationTrendStrategy extends BaseIntegrationTest {

    @Autowired
    BarSeriesService barSeriesService;

    @Autowired
    RecommendationTrendStrategy recommendationTrendStrategy;

    @Test
    public final void run() throws Exception {
        BarSeries barSeries = barSeriesService.getDataSet("ABB.ST", false, false);
        Strategy strategy = recommendationTrendStrategy.buildStrategy(barSeries);
