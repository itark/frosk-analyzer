...
/**
 * https://www.quandl.com/api/v3/datasets/BITFINEX/BTCEUR.json?api_key=CdaVrPkU7HH3Axd5pfNi
 * @author fredrikmoller
 *
 */
@Service
public class BITFINEXDataManager extends TimeSeriesManager {
	Logger logger = Logger.getLogger(BITFINEXDataManager.class.getName());
