...
/**
 * Risk-on when EUR/USD has NOT dropped more than 3% in the last 10 days.
 * Complement of {@link EURUSDRiskOffIndicator}.
 */
@Slf4j
public class EURUSDRiskOnIndicator extends CachedIndicator<Boolean> {

    private final Num threshold = DoubleNum.valueOf(3);
    private final int period = 10;

    public EURUSDRiskOnIndicator(BarSeries series) {
        super(series);
    }
