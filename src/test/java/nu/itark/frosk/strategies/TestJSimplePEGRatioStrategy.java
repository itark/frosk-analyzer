...
@Slf4j
@SpringBootTest
public class TestJSimplePEGRatioStrategy extends BaseIntegrationTest {

    @Autowired
    BarSeriesService barSeriesService;

    @Autowired
    SimplePEGRatioStrategy simplePEGRatioStrategy;

    @Test
    public final void run() throws Exception {
        BarSeries barSeries = barSeriesService.getDataSet("AAK.ST", false, false);
        Strategy strategy = simplePEGRatioStrategy.buildStrategy(barSeries);
