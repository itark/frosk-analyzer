...
/**
 * Risk-on when USD/JPY has NOT risen more than 2% in the last 5 days.
 * Complement of {@link USDJPYRiskOffIndicator}.
 */
@Slf4j
public class USDJPYRiskOnIndicator extends CachedIndicator<Boolean> {

    private final Num threshold = DoubleNum.valueOf(-2);
    private final int period = 5;

    public USDJPYRiskOnIndicator(BarSeries series) {
        super(series);
    }
