...
import static nu.itark.frosk.bot.bot.dto.util.CurrencyDTO.ETH;
import static nu.itark.frosk.bot.bot.dto.util.CurrencyDTO.EUR;
import static nu.itark.frosk.bot.bot.test.util.junit.BaseTest.*;
...
@ConditionalOnProperty(
        value = LargeTestableCassandreStrategy.PARAMETER_LARGE_TESTABLE_STRATEGY_ENABLED,
        havingValue = "true")
@Getter
